                            ...
                            <tr>
                                ...
                                <td class="text-end pe-4">
                                    <div class="btn-group shadow-sm">
                                        <a href="{{ route('events.questions.edit', $event->id) }}" class="btn btn-sm btn-outline-primary" title="Kelola Soal">
                                            <i class="fas fa-list-check"></i>
                                        </a>
                                        <a href="{{ route('events.edit', $event->id) }}" class="btn btn-sm btn-outline-warning" title="Edit Acara">
